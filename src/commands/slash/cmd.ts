import { type ApplicationCommand, type Collection, EmbedBuilder, type GuildResolvable, REST, Routes, SlashCommandBuilder } from "discord.js";
...
export default {
    ...
    run: async (interaction) => {
        ...
        if (!ownerCommand(interaction)) return interaction.reply("You are not the owner of this bot.");
